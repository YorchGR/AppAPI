...
class ExternalMessages(str, Enum):
    ...
    INVALID_USER_ID = "Número incorrecto de ID"
    ...
    INVALID_REACTIVE_USER = "El usuario ya se encuentra activado."
    INVALID_DISABLE_ADMIN = "La cuenta del administrador no puede ser desactivada"
